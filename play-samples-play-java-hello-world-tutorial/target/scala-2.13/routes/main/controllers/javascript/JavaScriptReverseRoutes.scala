...
package controllers.javascript {
  ...
  class ReverseHomeController(_prefix: => String) {
    ...
    def getStudentById: JavaScriptReverseRoute = JavaScriptReverseRoute(
      "controllers.HomeController.getStudentById",
      """
        function(id0) {
          return _wA({method:"GET", url:"""" + _prefix + { _defaultPrefix } + """" + "Students/" + encodeURIComponent((""" + implicitly[play.api.mvc.PathBindable[Int]].javascriptUnbind + """)("id", id0))})
        }
      """
    )
  
    // @LINE:10
    def Students: JavaScriptReverseRoute = JavaScriptReverseRoute(
      "controllers.HomeController.Students",
      """
        function() {
