...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """Students""", """controllers.HomeController.Students"""),
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """Students/""" + "$" + """id<[^/]+>""", """controllers.HomeController.getStudentById(id:Int)"""),
  ...
  // @LINE:10
  private[this] lazy val controllers_HomeController_Students4_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("Students")))
  )
  private[this] lazy val controllers_HomeController_Students4_invoker = createInvoker(
    HomeController_1.Students,
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "Students",
  ...
  // @LINE:11
  private[this] lazy val controllers_HomeController_getStudentById5_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("Students/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_HomeController_getStudentById5_invoker = createInvoker(
    HomeController_1.getStudentById(fakeValue[Int]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "getStudentById",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:10
    case controllers_HomeController_Students4_route(params@_) =>
      call { 
        controllers_HomeController_Students4_invoker.call(HomeController_1.Students)
      }
  
    // @LINE:11
    case controllers_HomeController_getStudentById5_route(params@_) =>
      call(params.fromPath[Int]("id", None)) { (id) =>
        controllers_HomeController_getStudentById5_invoker.call(HomeController_1.getStudentById(id))
      }
